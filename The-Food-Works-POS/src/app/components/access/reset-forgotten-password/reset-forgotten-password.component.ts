...
export class ResetForgottenPasswordComponent implements OnInit {
  ...
  constructor(public dialog: MatDialog, public dialogRef: MatDialogRef<ResetForgottenPasswordComponent>,
  ...
  ResetForgottenPassword() {
    if (this.userService.MustMatch(this.resetPasswordForm.value)) {
      this.userService.ResetForgottenPassword(this.resetPasswordForm.value).subscribe(res => {
        // route to login
  ...
  onSubmit() {
    this.userService.ResetForgottenPassword(this.resetPasswordForm.value).subscribe(() => {
      console.log('success');
    }, error => {
      console.log('error');
    });
