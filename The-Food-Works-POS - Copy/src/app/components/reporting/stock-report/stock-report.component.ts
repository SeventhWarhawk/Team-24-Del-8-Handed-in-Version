...
export class StockReportComponent implements OnInit {
  ...
  constructor(public adminService: AdminService, public serv: ReportService, private router: Router, private fb: FormBuilder, private http: HttpClient, private service: ReportService, public dialog: MatDialog,
  ...
  viewProduct: any;
  branchData: Branch[];
  displayedColumns: string[] = ['ProductName', 'ProductPrice', 'QOH', 'value'];
